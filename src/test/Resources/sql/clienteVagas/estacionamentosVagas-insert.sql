...
ALTER TABLE users_tb ALTER COLUMN id_user RESTART WITH 100;
...
ALTER TABLE clientes_tb ALTER COLUMN id_cliente RESTART WITH 100;

INSERT INTO vagas_tb (id_vaga, codigo_vaga, status_vaga) VALUES(1, 'A-01', 'OCUPADA');
INSERT INTO vagas_tb (id_vaga, codigo_vaga, status_vaga) VALUES(2, 'A-02', 'OCUPADA');
INSERT INTO vagas_tb (id_vaga, codigo_vaga, status_vaga) VALUES(3, 'A-03', 'OCUPADA');
ALTER TABLE vagas_tb ALTER COLUMN id_vaga RESTART WITH 100;
